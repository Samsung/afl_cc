        ...
        if (StrippedPtr != PtrOp) {
          ...
          if (HasZeroPointerIndex) {
            ...
            if (const ArrayType *CATy =
              ...
              if (CATy->getElementType() == StrippedPtrTy->getElementType()) {
                ...
                GetElementPtrInst *Res =
                  GetElementPtrInst::Create(StrippedPtrTy->getElementType(),
					    StrippedPtr, Idx, GEP->getName(), GEP);
            ...
            if (TD && SrcElTy->isArrayTy() &&
              ...
              Value *NewGEP = GetElementPtrInst::Create(SrcElTy,
							StrippedPtr, Idx,
                                                        GEP->getName(), GEP);
            ...
            if (TD && SrcElTy->isArrayTy() && ResElTy->isIntegerTy(8)) {
              ...
              if (ArrayEltSize && Scale && Scale->getSExtValue() >= 0LL &&
                ...
                Value *NewGEP = GetElementPtrInst::Create(SrcElTy,
							  StrippedPtr, Idx,
                                                          GEP->getName(), GEP);
                GEP->replaceAllUsesWith(new BitCastInst(NewGEP, GEP->getType(),
							GEP->getName(), GEP));
                continue;
              }
            }
