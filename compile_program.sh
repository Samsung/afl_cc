...
#AFL_BUILD_TYPE=FUZZING AFL_DICT_TYPE=NORMAL AFL_CONVERT_COMPARISON_TYPE=NONE AFL_COVERAGE_TYPE=NO_COLLISION $BCLANG_FAST $EXEBC $LLVM_PASS_ARGS -o $EXE-coverage $LDFLAGS || err_exit "Failed 1"
